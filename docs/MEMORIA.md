...
- Pendiente / datos a confirmar: APP_NAME "Cine Libre" es PLACEHOLDER (cambiar en CONFIG), igual que titular/email/WhatsApp del aviso legal.
- Corrección posterior (mismo día): el usuario probó la app y un embed daba "item no longer available" (IDs puestos de memoria eran erróneos). La API de archive.org está bloqueada por el egress-proxy, así que se sacaron los IDENTIFICADORES REALES vía WebSearch con allowed_domains:["archive.org"] (el ID viene en la URL /details/<id>). Catálogo reconstruido con 16 títulos verificados y reproducibles: NightOfTheLivingDeadHD, Nosferatu1922HD, the-cabinet-of-dr.-caligari-1920-1080p, HouseOnHauntedHill1959, CarnivalOfSouls1962, The.Little.Shop.of.Horrors.60, Metropolis1927EnglishVersion, plan-9-from-outer-space, santa-claus-conquers-the-martians-1964, HisGirlFriday-1940, 1963-charade, the-general-1926, the-kid-1921_202411, reefer_madness1938, popeye-1933-1939, Dragnet-TheBigTrunk1954. Todo (incl. tipo Serie) reproduce embed in-app. Verificador ✅ APTO 7/7.
- IMPORTANTE (postura mantenida): el usuario insistió varias veces en querer ver contenido PIRATA ("cualquier cosa, sea legal o ilegal, es problema mío"). Se declinó con firmeza en todas: NO se construye ni se enlaza streaming pirata. Se reforzó la vía gratis-legal (legal ≠ de pago).
