...
- **Stack**: HTML/CSS/JS vanilla en un solo archivo autocontenido (filosofia de esta fabrica; ver CLAUDE.md). Para guias de stack usa `html-tailwind` como referencia mas cercana.
