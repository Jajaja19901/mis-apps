...
<meta name="description" content="Logopedia de Laura M M: apoyo para niños (enseñar a hablar y leer) y para adultos (afasia, ELA, memoria). Elige el público y practica en casa.">
...
<div id="app">
  <section id="chooser">
    <div class="ch-head">
      ...
      <p>Elige para quién es. Cada parte tiene sus propios ejercicios y se lee en voz alta.</p>
    </div>
    <div class="ch-cards">
      <button class="ch-card kids" data-action="go" data-m="ninos">
        <span class="ce" aria-hidden="true">&#129490;</span>
        <b>Para niños</b>
        <small>Enseñar a hablar y a leer: articulación, vocabulario, lectoescritura, comunicar y agenda visual (TEA).</small>
        <span class="pill">Entrar &rarr;</span>
      </button>
      <button class="ch-card adults" data-action="go" data-m="adultos">
        <span class="ce" aria-hidden="true">&#129489;</span>
        <b>Para adultos</b>
        <small>Rehabilitación neurológica: comunicación (afasia, ELA), lenguaje, memoria y orientación, y praxias.</small>
        <span class="pill">Entrar &rarr;</span>
      </button>
    </div>
    <div class="ch-foot">
      ...
      <div style="margin-top:8px;color:#5b6b7b">Diseñado por Incuba tu Negocio &middot; por Jaime M. M.</div>
    </div>
  </section>
  <section id="stage" hidden>
    ...
    <iframe id="frame" title="Aplicación de logopedia" allow="autoplay"></iframe>
  </section>
</div>
...
[
  { "name": "La portada deja elegir ninos o adultos", "steps": [
    { "goto": "#" }, { "expectVisible": "#chooser" }, { "expect": "Para niños" }, { "expect": "Para adultos" } ]},
...
var TITLES={ninos:"\\uD83E\\uDDD2 Para niños",adultos:"\\uD83E\\uDDD1 Para adultos"};
var loaded=null;
